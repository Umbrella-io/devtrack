...
const PERSONA_PROFILES: Record<PersonaKey, PersonaProfile> = {
  night_owl: {
    ...
    gradient: "from-indigo-500/20 via-slate-950/85 to-slate-950",
  },
  early_bird: {
    key: "early_bird",
    title: "Early Bird",
    ...
    gradient: "from-amber-400/25 via-orange-500/20 to-slate-950",
  },
  refactorer: {
    key: "refactorer",
    title: "Refactorer",
    ...
    gradient: "from-emerald-400/20 via-cyan-500/15 to-slate-950",
  },
  marathoner: {
    key: "marathoner",
    title: "Marathoner",
    ...
    gradient: "from-rose-500/20 via-fuchsia-500/15 to-slate-950",
  },
  speed_runner: {
    key: "speed_runner",
    title: "Speed Runner",
    ...
    gradient: "from-sky-400/20 via-blue-500/15 to-slate-950",
  },
  balanced_builder: {
    ...
    gradient: "from-slate-500/20 via-slate-700/15 to-slate-950",
  },
};
