...
const StreakTracker = dynamic(() => import("@/components/StreakTracker"), {
  ssr: false,
  loading: () => <SkeletonCard />,
});
const RepoAnalyticsExplorer = dynamic(
  () => import("@/components/repo-analytics/RepoAnalyticsExplorer"),
  { ssr: false, loading: () => <SkeletonCard /> },
);
const PinnedReposWidget = dynamic(
  () => import("@/components/PinnedReposWidget"),
  { ssr: false, loading: () => <SkeletonCard /> },
);
const TopRepos = dynamic(() => import("@/components/TopRepos"), {
  ssr: false,
  loading: () => <SkeletonCard />,
});
const InactiveRepositoriesCard = dynamic(
  () => import("@/components/InactiveRepositoriesCard"),
  { ssr: false, loading: () => <SkeletonCard /> },
);
