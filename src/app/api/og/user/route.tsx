        ...
        >
          <div style={{ display: "flex", alignItems: "center", gap: "28px" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "6px" }}>
              <span style={{ fontSize: "38px", fontWeight: 700, color: "#f8fafc" }}>
                {name}
              </span>
          ...
          <div style={{ display: "flex", gap: "56px" }}>
            <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: "8px" }}>
              ...
              <span style={{ fontSize: "30px", fontWeight: 700, color: "#f97316" }}>
                {streak} days
              </span>
            </div>
            ...
            <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: "8px" }}>
              ...
              <span style={{ fontSize: "30px", fontWeight: 700, color: "#6366f1" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: "8px" }}>
              ...
              <span style={{ fontSize: "30px", fontWeight: 700, color: "#10b981" }}>
                {topLang}
              </span>
            </div>
          </div>
