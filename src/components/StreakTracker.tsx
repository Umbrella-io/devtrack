        ...
        {data && (
          <div className="absolute top-6 right-6 flex items-center gap-2 z-10">
            <button
              type="button"
              onClick={handleCopy}
              className="cursor-pointer flex h-8 items-center justify-center rounded-md px-2 text-sm text-[var(--muted-foreground)] hover:bg-[var(--control)] hover:text-[var(--card-foreground)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--accent)] transition-colors"
            ...
            <button
              ...
              className="cursor-pointer flex h-8 items-center justify-center rounded-md px-3 py-1.5 text-xs font-medium bg-[var(--accent)] text-[var(--accent-foreground)] hover:opacity-90 disabled:opacity-70 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--accent)] transition-colors gap-1.5 shadow-sm"
          ...
          >
            ...
            <div className="mt-1 flex items-center justify-center gap-1 text-xs text-[var(--muted-foreground)]">
              ...
              <button
                type="button"
                aria-label={stat.tooltip}
                className="text-[var(--muted-foreground)] hover:text-[var(--accent)] focus-visible:outline-none"
              >
                <svg
