...
export default function StreakTracker() {
  ...
  if (error) {
    ...
    return (
      <div className="rounded-xl border border-[var(--border)] bg-[var(--card)] p-6 shadow-sm min-h-[420px] transition-all duration-300 hover:shadow-md hover:-translate-y-1">
  ...
  return (
    <>
      ...
      <div className="relative">
        {data && (
          <div className="absolute top-6 right-6 flex items-center gap-2 z-10">
            <button
              type="button"
              onClick={handleCopy}
              className="cursor-pointer flex h-8 items-center justify-center rounded-md px-2 text-sm text-[var(--muted-foreground)] hover:bg-[var(--control)] hover:text-[var(--card-foreground)] focus:outline-none focus:ring-2 focus:ring-[var(--accent)] transition-all hover:opacity-90 active:scale-95"
            ...
            <button
              ...
              className="cursor-pointer flex h-8 items-center justify-center rounded-md px-3 py-1.5 text-xs font-medium bg-[var(--accent)] text-[var(--accent-foreground)] hover:opacity-90 disabled:opacity-70 focus:outline-none focus:ring-2 focus:ring-[var(--accent)] transition-all gap-1.5 shadow-sm active:scale-95"
        ...
        <div ref={containerRef} className="rounded-xl border border-[var(--border)] bg-[var(--card)] p-6 shadow-sm transition-all duration-300 hover:shadow-md hover:-translate-y-1">
      ...
      {monthlyTrend.isValid && (
        <div className="mt-3 flex items-center justify-between rounded-lg border border-[var(--border)] bg-[var(--card)] px-4 py-2.5 text-xs shadow-sm transition-all duration-300 hover:shadow-md hover:-translate-y-1">
        ...
        <div className="mt-4 flex items-center justify-between rounded-lg border border-[var(--accent)]/30 bg-[var(--accent-soft)] px-4 py-3">
          ...
          {confirmCancel ? (
            ...
            <button
              type="button"
              onClick={handleCancelFreeze}
              className="rounded-md border border-[var(--border)] px-3 py-1 text-xs font-medium text-[var(--muted-foreground)] transition hover:bg-[var(--control)] transition-all duration-200 hover:opacity-90 active:scale-95"
            >
              Cancel freeze
            </button>
          )}
      ...
      <div className="mb-6 flex items-center justify-between">
        ...
        <div className="flex gap-2">
          <button
            ...
            className="rounded-md px-2 py-1 hover:bg-[var(--control)] transition-all text-sm font-medium hover:opacity-90 active:scale-95"
