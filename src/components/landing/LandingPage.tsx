...
function LandingNav() {
  ...
  return (
    ...
    >
      ...
      <a aria-label="Interactive element" href="/api/auth/signin/github?callbackUrl=/dashboard" className="lnd-nav-link">
        SIGN IN →
      </a>
    </nav>
  );
    ...
    >
      ...
      <div style={{ flex: '1 1 340px', maxWidth: 500 }}>
        ...
        <div style={{ display: 'flex', gap: 12, flexWrap: 'wrap' }}>
          <a aria-label="Interactive element" href="/api/auth/signin/github?callbackUrl=/dashboard" className="lnd-cta-primary">
    ...
    <footer style={{
      ...
      <div style={{ display: 'flex', gap: 20 }}>
        {[
          ...
          <a aria-label="Interactive element" key={l.label} href={l.href} target="_blank" rel="noopener noreferrer" className="lnd-footer-link">
            {l.label}
          </a>
        ))}
      </div>
