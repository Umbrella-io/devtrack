          ...
          <div className="flex w-full min-w-0 items-center gap-3 overflow-x-auto pb-1 md:w-auto md:justify-end md:overflow-visible md:pb-0">
            {isPublic === true && session?.githubLogin && (
              <a
                ...
                className="primary-button inline-flex items-center justify-center rounded-xl px-3 py-1.5 text-xs font-semibold sm:px-4 sm:py-2 sm:text-sm"
            ...
            <div className="flex flex-wrap items-center gap-1.5 sm:gap-2 rounded-2xl border border-[var(--border)] bg-[var(--card-muted)]/50 p-1.5 sm:p-2 shadow-sm backdrop-blur-sm">
