    ...
    >
      ...
      <div className="relative z-10 flex flex-col md:flex-row md:items-center md:justify-between gap-8">
        ...
        <div>
          ...
          {/* Status Badge */}
          <div className="mt-4 inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[var(--card-muted)] border border-[var(--border)] text-[var(--success)] text-xs font-medium">
      ...
      <motion.div
        ...
        className="absolute top-6 right-6 hidden lg:flex items-center gap-2 px-3 py-2 rounded-xl bg-[var(--card-muted)] border border-[var(--border)] text-[var(--accent)] text-xs backdrop-blur-lg"
      >
