    ...
    <>
      ...
      >
            <div className="mb-4 flex items-start justify-between gap-4">
              ...
              <button aria-label="Interactive element" onClick={onClose} className="rounded-lg border border-[var(--border)] px-3 py-1 text-sm text-[var(--muted-foreground)]">Close</button>
            </div>
