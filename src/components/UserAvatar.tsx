...
export default function UserAvatar() {
  ...
  return (
    <a
      ...
      tabIndex={0}
      className="inline-flex h-10 items-center gap-2 rounded-full border border-[var(--border)] bg-[var(--card)] px-3 text-sm text-[var(--card-foreground)] hover:bg-[var(--control)] transition-colors"
    >
