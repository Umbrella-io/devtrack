...
export default function FriendComparison() {
  ...
  return (
    <div className="rounded-xl border border-[var(--border)] bg-[var(--card)] p-6 shadow-sm">
      ...
      {error && (
        <div className="p-4 mb-4 rounded-md border border-[var(--destructive-muted-border)] bg-[var(--destructive-muted)] text-[var(--destructive)] text-sm flex justify-between items-center">
          <span>{error}</span>
        ...
        <div className="space-y-4">
          ...
          <div className="flex justify-center items-center gap-3 pt-4">
            ...
            <button
              ...
              className="rounded-full bg-[var(--control)] px-4 py-2 text-sm text-[var(--foreground)] transition-colors hover:bg-[var(--destructive-muted)] hover:text-[var(--destructive)]"
            >
              Clear Comparison
            </button>
          </div>
