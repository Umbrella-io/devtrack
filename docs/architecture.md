...
## Database Connection pooling (Issue #1955)
Configure PgBouncer connection limits and Prisma pooling strategies to optimize database connections in serverless environments.